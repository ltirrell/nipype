...
def create_AutoRecon3(name="AutoRecon3", qcache=False, plugin_args=None,
    ...
    for hemisphere, hemi_wf in [('lh', ar3_lh_wf1), ('rh', ar3_rh_wf1)]:
        ...
        ar3_wf.connect([(inputspec, hemi_wf, [('{0}_inflated'.format(hemisphere), 'inputspec.inflated'),
                                              ('{0}_smoothwm'.format(hemisphere),
                                               'inputspec.smoothwm'),
                                              ('{0}_white_preaparc'.format(hemisphere), 'inputspec.white_preaparc'),
    ...
    for hemisphere, hemiwf2 in [('lh', ar3_lh_wf2),  ('rh', ar3_rh_wf2)]:
        ...
        ar3_wf.connect([(inputspec, hemiwf2, [('wm', 'inputspec.wm'),
                        ...
                        (ar3_lh_wf1, hemiwf2, [('outputspec.pial', 'inputspec.lh_pial'),
                                               ('outputspec.white', 'inputspec.lh_white')]),
                        (ar3_rh_wf1, hemiwf2, [('outputspec.pial', 'inputspec.rh_pial'),
                                               ('outputspec.white', 'inputspec.rh_white')]),
    ...
    ar3_wf.connect([(apas_2_aseg, segstats, [('out_file', 'segmentation_file')]),
                    (inputspec, segstats, [('transform', 'transform'),
                                           ('norm', 'in_intensity'),
    ...
    ar3_wf.connect([(wm_parcellation, wm_segstats, [('out_file', 'segmentation_file')]),
                    (inputspec, wm_segstats, [('transform', 'transform'),
                                              ('norm', 'in_intensity'),
                                              ('norm', 'partial_volume_file'),
                                              ('brainmask', 'brainmask_file'),
                                              ('lh_orig_nofix',
    ...
    ar3_wf.connect([(ar3_lh_wf1, ba_WF, [('outputspec.sphere_reg', 'inputspec.lh_sphere_reg'),
                    ...
                    (ar3_rh_wf1, ba_WF, [('outputspec.sphere_reg', 'inputspec.rh_sphere_reg'),
                                         ...
                                         ('outputspec.white', 'inputspec.rh_white')]),
                    (inputspec, ba_WF, [('transform', 'inputspec.transform'),
